...
{
   cerr << "in the destructor for object at: " << this << endl;
   cerr << "   dynamic array returned at: " << list << endl;
	delete [] list;
}
...
{
cerr << "copying " << otherList.list[j] << endl;
        list [j] = otherList.list[j];
}
cerr << "exiting copy constructor\n";
...
const arrayListType& arrayListType::operator=(const  
              arrayListType& arg)
{
   if (this == &arg) 
{
cerr << "hey don't be silly\n";
      return *this;
}
   delete [] list;
   length = arg.length;
